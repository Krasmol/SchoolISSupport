...
namespace SchoolISSupport
{
    public partial class Form1 : Form
    {
        ...
        {
            this.Text = "📊 Сопровождение ИС образовательной организации";
            ...
            btnBestRequester.FlatAppearance.BorderSize = 0;
            ...
            dgvBestRequester = new DataGridView
            {
            ...
            StyleDataGridView(dgvBestRequester);
            ...
            btnTopSoftware.FlatAppearance.BorderSize = 0;
            ...
            dgvTopSoftware = new DataGridView
            {
                Location = new Point(15, 145),
                Size = new Size(350, 270),
                AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill,
            ...
            StyleDataGridView(dgvTopSoftware);
            ...
            btnNoProblems.FlatAppearance.BorderSize = 0;
            ...
            dgvNoProblems = new DataGridView
            {
                Location = new Point(15, 145),
                Size = new Size(350, 270),
                AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill,
            ...
            StyleDataGridView(dgvNoProblems);
            ...
            userLabel = new ToolStripStatusLabel("👤 Администратор");
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                MessageBox.Show("Не удалось подключиться к базе данных.\n\n" +
                    "Убедитесь, что файл базы данных (.mdb или .accdb) находится в папке:\n" +
        ...
        private void LoadRequests() => dgvRequests.DataSource = DatabaseHelper.GetSupportRequests();

        private void BtnBestRequester_Click(object sender, EventArgs e)
        {
            statusLabel.Text = "⏳ Выполняется запрос...";
            ...
            if (result != null && result.Rows.Count > 0)
            {
                ...
                lblBestRequesterResult.ForeColor = Color.Green;
                statusLabel.Text = $"✅ Запрос выполнен. Лидер: {name} ({count} заявок)";
            }
            else
            {
                dgvBestRequester.DataSource = null;
                lblBestRequesterResult.Text = "⚠ За текущий месяц нет заявок";
                lblBestRequesterResult.ForeColor = Color.Orange;
                statusLabel.Text = "⚠ Нет данных за текущий месяц";
            }
        }
        ...
        private void BtnTopSoftware_Click(object sender, EventArgs e)
        {
            ...
            if (result != null && result.Rows.Count > 0)
            {
                ...
                lblTopSoftwareResult.ForeColor = Color.Green;
                statusLabel.Text = $"✅ Запрос выполнен. Лидер: {name} ({count} установок)";
            }
            else
            {
                dgvTopSoftware.DataSource = null;
                lblTopSoftwareResult.Text = "⚠ Данные о программах не найдены";
                lblTopSoftwareResult.ForeColor = Color.Orange;
                statusLabel.Text = "⚠ Нет данных о программах";
            }
        }
        ...
        private void BtnNoProblems_Click(object sender, EventArgs e)
        {
            ...
            if (result != null && result.Rows.Count > 0)
            {
                ...
                lblNoProblemsResult.ForeColor = Color.Green;
                statusLabel.Text = $"✅ Запрос выполнен. Найдено {result.Rows.Count} аудиторий без проблем";
            }
            else
            {
                dgvNoProblems.DataSource = null;
                lblNoProblemsResult.Text = "⚠ Нет аудиторий без проблем";
                lblNoProblemsResult.ForeColor = Color.Orange;
                statusLabel.Text = "⚠ Нет аудиторий без проблем";
            }
        }
